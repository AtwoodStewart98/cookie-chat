angular.module("chatroom").service("messageService", function($http) {
  ...
  var self = this;
  var sharedUrl = "https://practiceapi.devmountain.com/api/chats";
  ...
  this.getMessages = function() {
    return $http.get(sharedUrl).then(function(resp) {
      console.log(resp);
  ...
  this.postMessage = function(txt) {
    return $http.post(sharedUrl, { message: txt });
  };
});
